...
class Updatable(sprite.Sprite, metaclass=ABCMeta):
    """Interface for objects that need to be updated each frame/tick."""
...
class Drawable(sprite.Sprite, metaclass=ABCMeta):
    """Interface for objects that can be rendered to a screen or surface."""
...
class Spritable(Updatable, Drawable, metaclass=ABCMeta):
    """Interface for objects that can be both updated & rendered."""
    pass
