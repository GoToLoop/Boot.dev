...
def get_filter_cmd(
    ...
    def filter_cmd(content: str, option: str = "--one") -> str:
        match option:
            ...
            case _: raise Exception("invalid option")

    return filter_cmd

# Don't touch below this line

def replace_bad(text: str) -> str: return text.replace("bad", "good")
def replace_ellipsis(text: str) -> str: return text.replace("..", "...")
def fix_ellipsis(text: str) -> str: return text.replace("....", "...")
