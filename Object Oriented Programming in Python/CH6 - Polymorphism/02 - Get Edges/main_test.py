...
RectangleBounds = tuple[int, int, int, int]
TestCase = tuple[RectangleArgs, RectangleBounds]
...
def test(rect_args: RectangleArgs, expected_output: RectangleBounds) -> bool:
